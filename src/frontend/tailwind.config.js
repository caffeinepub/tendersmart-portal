  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        card: "0 2px 8px rgba(34,49,100,0.08), 0 1px 2px rgba(34,49,100,0.05)",
        "card-hover": "0 8px 24px rgba(34,49,100,0.14), 0 2px 8px rgba(34,49,100,0.08)",
        navy: "0 4px 24px rgba(34,49,100,0.25)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
